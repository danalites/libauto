...
# python docker/ui-detection/run_single.py --img /Users/hecmay/Desktop/tt1.png --op_dir ./ --min_grad 5 --ffl_block 5 --min_ele_area 50 --max_word_inline_gap 4 --max_line_gap 4

parser = ArgumentParser()
parser.add_argument("--img", type=str, help="path/to/img")
parser.add_argument("--op_dir", type=str, help="path/to/output/directory")
parser.add_argument("--min_grad", type=int, default=5, help="Gradient Threshold to produce Binary Map")
parser.add_argument("--ffl_block", type=int, default=5, help="Fill-flood threshold")
parser.add_argument("--min_ele_area", type=int, default=50, help="Minimum Area for Components")
